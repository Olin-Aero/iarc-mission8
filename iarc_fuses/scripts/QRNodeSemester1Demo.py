...
class QRNode():
    def __init__(self):
        ...
        self.drone1ImageSub = rospy.Subscriber('/bepop/image_raw',Image,self.drone1CB) # The ros interfacing won't work yet as I haven't figured out how to convert a ROS image to PIL Image
