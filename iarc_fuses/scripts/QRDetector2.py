...
stitchedImage = np.zeros((400,400), np.uint8)
for i in range(4):
	if i == 0:
		y_offset = 0
		x_offset = 0
	...
	stitchedImage[y_offset:y_offset+images[i].shape[0], x_offset:x_offset+images[i].shape[1]] = images[i]

cv2.imwrite('FinalImage.png',stitchedImage)
# rotate it
# crop it
# stitch it